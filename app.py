...
def mostrar_ficha():
    ficha_html = (
        ...
        "Licencia: <a href='https://github.com/BlueLaserGo/limpiatext' target='_blank' rel='noopener noreferrer' style='color: #111111; font-weight: 600; text-decoration: underline;'>MIT License</a> • © 2026 Laura Serrano Gómez"
        "</div>"
        "</div>"
    )
