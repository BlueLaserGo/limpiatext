...
css_styles = (
    ...
    "div[data-testid='stFileUploader'] button { background-color: #111111 !important; color: #FFFFFF !important; border-radius: 4px !important; font-family: 'Space Grotesk', sans-serif !important; font-size: 0.82rem !important; font-weight: 600 !important; border: 1px solid #111111 !important; transition: all 0.2s ease !important; }\n"
    "div[data-testid='stFileUploader'] button:hover { background-color: #FACC15 !important; border-color: #FACC15 !important; color: #111111 !important; }\n"    ".lang-item { display: flex; align-items: center; gap: 8px; margin-bottom: 4px; font-size: 0.80rem; color: #222222; white-space: nowrap; }\n"
