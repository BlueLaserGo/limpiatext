...
css_styles = (
    ...
    "div[data-testid='stFileUploaderDropzone'] button { font-size: 0 !important; background-color: #111111 !important; color: #FFFFFF !important; border: 1px solid #111111 !important; border-radius: 4px !important; padding: 0.35rem 1rem !important; transition: all 0.2s ease !important; }\n"
    "div[data-testid='stFileUploaderDropzone'] button::after { content: 'Seleccionar archivo'; font-family: 'Space Grotesk', sans-serif !important; font-size: 0.85rem !important; font-weight: 600 !important; color: #FFFFFF !important; }\n"
    "div[data-testid='stFileUploaderDropzone'] button:hover { background-color: #FACC15 !important; border-color: #FACC15 !important; }\n"
    "div[data-testid='stFileUploaderDropzone'] button:hover::after { color: #111111 !important; }\n"
...
with tab_app:
    ...
    if "df_resultado" in st.session_state and st.session_state["df_resultado"] is not None:
        ...
        # TABLA EDITABLE (Human-in-the-loop real)
        ...
        # Generación de archivos con los datos EDITADOS
...
with tab_guia:
    ...
    card_faq_html = (
        ...
        "Si vas a subir un <b>archivo CSV propio</b>, solo necesitas introducir una clave gratuita de Gemini (obtenida en <a href='https://aistudio.google.com/app/api-keys' target='_blank' style='color: #0066CC; text-decoration: underline; font-weight: 500;'>Google AI Studio &#8599;</a>) en la barra lateral.</p>"
